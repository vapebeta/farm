...
public:
	void init() {
		...
		_additive.setup(XOR("additive"), XOR("distortion_additive"), { XOR("shift"), XOR("force-turn") });
		distortion_additive.AddShowCallback(callbacks::IsAntiAimModeStand);
		distortion_additive.AddShowCallback(callbacks::HasStandYaw);
		distortion_additive.AddShowCallback(callbacks::DistortionEnabled);
		RegisterElement(&distortion_additive);

		distortion_amount.setup(XOR("distortion angle"), XOR("distortion_amount"), -180, 180, true, 0, 0.f, 1.f, XOR(L"°"));
		...
		distortion_amount.AddShowCallback(callbacks::ShiftEnabled);
...
public:
	void init() {
		...
		history_skeleton_col.setup(XOR("skeleton color"), XOR("history_skeleton_col"), { 255, 255, 255 });
		history_skeleton_col.AddShowCallback(callbacks::IsHistorySkel);
		RegisterElement(&history_skeleton_col, 1);

		history_skeleton_alpha.setup("", XOR("skeleton_alpha"), 10.f, 100.f, false, 0, 60.f, 1.f, XOR(L"%"));
		history_skeleton_alpha.AddShowCallback(callbacks::IsHistorySkel);
		RegisterElement(&history_skeleton_alpha, 1);
...
public:
	void init() {
		...
		indicators.setup(XOR("indicators"), XOR("indicators"), { XOR("lby"), XOR("lag compensation"), XOR("fake latency"), XOR("damage") });
