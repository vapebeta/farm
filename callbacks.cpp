...
//bool callbacks::ShiftEnabled() {
//	return g_menu.main.antiaim.distortion_additive.get(0);
//}
...
bool callbacks::IsHistorySkel() {
	return g_menu.main.players.history_skeleton.get();
}
...
{
	return g_menu.main.misc.bullet_impacts.get();
}
