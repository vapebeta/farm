...
bool LagCompensation::StartPrediction(AimPlayer* data) {
	...
	while (true) {
		// can the player shoot within his lag delta. TESTING -- NEXUS
...
//		if (g_csgo.m_globals->m_realtime - sequence.flCurrentTime >= flLatency) {
//			pNetChannel->m_in_rel_state = sequence.iInReliableState;
//			pNetChannel->m_in_seq = sequence.iSequenceNr;
//			break;
//		}
//	}
//}